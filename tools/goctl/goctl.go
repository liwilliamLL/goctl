...
import (
	...
	"william/base/go-zero/tools/goctl/api/apigen"
	"william/base/go-zero/tools/goctl/api/dartgen"
	"william/base/go-zero/tools/goctl/api/docgen"
	"william/base/go-zero/tools/goctl/api/format"
	"william/base/go-zero/tools/goctl/api/gogen"
	"william/base/go-zero/tools/goctl/api/javagen"
	"william/base/go-zero/tools/goctl/api/ktgen"
	"william/base/go-zero/tools/goctl/api/new"
	"william/base/go-zero/tools/goctl/api/tsgen"
	"william/base/go-zero/tools/goctl/api/validate"
	"william/base/go-zero/tools/goctl/configgen"
	"william/base/go-zero/tools/goctl/docker"
	"william/base/go-zero/tools/goctl/kube"
	"william/base/go-zero/tools/goctl/model/mongo"
	model "william/base/go-zero/tools/goctl/model/sql/command"
	"william/base/go-zero/tools/goctl/plugin"
	rpc "william/base/go-zero/tools/goctl/rpc/cli"
	"william/base/go-zero/tools/goctl/tpl"
	"william/base/go-zero/tools/goctl/upgrade"
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "style",
							Usage: "the file naming format, see [https://william/base/go-zero/tree/master/tools/goctl/config/readme.md]",
						},
					},
					...
					Subcommands: []cli.Command{
						{
							...
							Flags: []cli.Flag{
								...
								cli.BoolFlag{
									Name: "merge",
									Usage: "the merge tables [optional]",
								},
							},
						...
						},
						{
							...
							Flags: []cli.Flag{
								...
								cli.StringFlag{
									Name:  "cfg",
									Usage: "the model config [optional]",
								},
								cli.StringFlag{
									Name: "merge",
									Usage: "the merge tables [optional]",
